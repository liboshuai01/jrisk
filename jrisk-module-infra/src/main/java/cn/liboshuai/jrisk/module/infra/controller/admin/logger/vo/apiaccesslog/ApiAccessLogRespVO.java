package cn.liboshuai.jrisk.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import cn.liboshuai.jrisk.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.liboshuai.jrisk.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "李博帅，牛逼！")
    @ExcelProperty("结果提示")

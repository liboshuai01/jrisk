package cn.liboshuai.jrisk.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableSaveReqVO {
    ...
    @Schema(description = "表名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "jrisk")
    ...
    @Schema(description = "作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "李博帅")

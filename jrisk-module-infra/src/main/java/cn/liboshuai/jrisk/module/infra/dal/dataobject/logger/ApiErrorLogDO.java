package cn.liboshuai.jrisk.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 cn.liboshuai.jrisk.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */

...
import cn.liboshuai.jrisk.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "jrisk.tracer", value = "enable", matchIfMissing = true)
public class JriskTracerAutoConfiguration {

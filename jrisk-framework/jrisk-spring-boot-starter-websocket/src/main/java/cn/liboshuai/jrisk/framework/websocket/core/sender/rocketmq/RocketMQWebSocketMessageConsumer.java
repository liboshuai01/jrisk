package cn.liboshuai.jrisk.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${jrisk.websocket.sender-rocketmq.topic}",
        consumerGroup = "${jrisk.websocket.sender-rocketmq.consumer-group}",

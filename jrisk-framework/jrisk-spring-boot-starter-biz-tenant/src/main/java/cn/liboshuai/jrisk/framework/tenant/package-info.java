 ...
 *      1）Spring Async：
 *          {@link cn.liboshuai.jrisk.framework.quartz.config.JriskAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 JriskSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.liboshuai.jrisk.framework.tenant;

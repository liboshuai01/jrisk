package cn.liboshuai.jrisk.framework.web.config;
...
import cn.liboshuai.jrisk.framework.web.core.filter.CacheRequestBodyFilter;
import cn.liboshuai.jrisk.framework.web.core.filter.DemoFilter;
import cn.liboshuai.jrisk.framework.web.core.handler.GlobalExceptionHandler;
import cn.liboshuai.jrisk.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class JriskWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "jrisk.demo", havingValue = "true")

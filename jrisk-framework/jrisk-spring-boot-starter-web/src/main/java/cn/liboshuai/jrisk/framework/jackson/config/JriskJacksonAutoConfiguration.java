package cn.liboshuai.jrisk.framework.jackson.config;

import cn.liboshuai.jrisk.framework.common.util.json.JsonUtils;
import cn.liboshuai.jrisk.framework.common.util.json.databind.NumberSerializer;
import cn.liboshuai.jrisk.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.liboshuai.jrisk.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class JriskJacksonAutoConfiguration {

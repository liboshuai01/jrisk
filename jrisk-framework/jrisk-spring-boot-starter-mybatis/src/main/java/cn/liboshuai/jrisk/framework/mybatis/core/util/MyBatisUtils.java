package cn.liboshuai.jrisk.framework.mybatis.core.util;
...
import cn.liboshuai.jrisk.framework.mybatis.core.enums.DbTypeEnum;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        page.setOptimizeJoinOfCountSql(false); // 关联 issue：https://gitee.com/zhijiantianya/jrisk-cloud/issues/ID2QLL
        // 排序字段

package cn.liboshuai.jrisk.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.liboshuai.jrisk.framework.common.util.json.JsonUtils;
import cn.liboshuai.jrisk.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${jrisk.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class JriskMybatisAutoConfiguration {

...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.liboshuai.project";
    private static final String ARTIFACT_ID = "jrisk";
    private static final String PACKAGE_NAME = "cn.liboshuai.jrisk";
    private static final String TITLE = "Juc风控系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.liboshuai.project";
        String artifactIdNew = "jrisk";
        String packageNameNew = "cn.liboshuai.jrisk";
        String titleNew = "Juc风控系统";
        String projectBaseDirNew = "C:/Users/lbs/me/project/ruoyi-project/jrisk"; // 一键改名后，“新”项目所在的目录

...
public class CondSaveReqVO {
    ...
    @Schema(description = "编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "28137")
    private Long id;

    @Schema(description = "条件编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "19606")
    @NotNull(message = "条件编号不能为空")
    private Long condId;

    @Schema(description = "条件类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "recent")
    ...
    @Schema(description = "规则编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "18272")

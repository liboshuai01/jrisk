package cn.liboshuai.jrisk.module.system.service.social;
...
import cn.liboshuai.jrisk.framework.common.util.cache.CacheUtils;
import cn.liboshuai.jrisk.framework.common.util.http.HttpUtils;
import cn.liboshuai.jrisk.framework.common.util.object.BeanUtils;
import cn.liboshuai.jrisk.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.liboshuai.jrisk.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.liboshuai.jrisk.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.liboshuai.jrisk.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.liboshuai.jrisk.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.liboshuai.jrisk.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.liboshuai.jrisk.module.system.dal.dataobject.social.SocialClientDO;
import cn.liboshuai.jrisk.module.system.dal.mysql.social.SocialClientMapper;
import cn.liboshuai.jrisk.module.system.dal.redis.RedisKeyConstants;
import cn.liboshuai.jrisk.module.system.enums.social.SocialTypeEnum;
import cn.liboshuai.jrisk.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.liboshuai.jrisk.framework.common.util.collection.MapUtils.findAndThen;
import static cn.liboshuai.jrisk.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.liboshuai.jrisk.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.liboshuai.jrisk.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${jrisk.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${jrisk.wxa-subscribe-message.miniprogram-state:formal}")

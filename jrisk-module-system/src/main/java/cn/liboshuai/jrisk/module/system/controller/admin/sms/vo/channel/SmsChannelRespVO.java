package cn.liboshuai.jrisk.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelRespVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "李博帅")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "jrisk")

package cn.liboshuai.jrisk.module.system.controller.admin.socail.vo.client;
...
import cn.liboshuai.jrisk.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "jrisk商城")
